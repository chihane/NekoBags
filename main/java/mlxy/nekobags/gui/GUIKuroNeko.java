...
public class GUIKuroNeko extends GuiContainer {
	...
	public GUIKuroNeko(IInventory inventoryPlayer, IInventory inventoryBag) {
		super(new ContainerKuroNekoBag(inventoryPlayer, inventoryBag));
	...
	protected void drawGuiContainerForegroundLayer(int p_146979_1_,
		...
		this.fontRendererObj
				.drawString(
						this.lowerChestInventory.hasCustomInventoryName() ? this.lowerChestInventory
								.getInventoryName() : I18n.format(
								this.lowerChestInventory.getInventoryName(),
								new Object[0]), 8, 6, 4210752);
		this.fontRendererObj
				.drawString(
						this.upperChestInventory.hasCustomInventoryName() ? this.upperChestInventory
								.getInventoryName() : I18n.format(
